package com.winit.alseer.salesman.imageloader;
...
//        Log.v(Constants.LOGTAG,targetHeight);
     ...
     *            image should be cached locally.
     */
    public static void setUrlDrawable(final Context context, final ImageView imageView, final String url, final int defaultResource, final long cacheDurationMs) {
        Drawable d = null;
