 ...
 *
 */
public class StoreCheckExpandableListViewAdapter extends BaseExpandableListAdapter
{
	 ...
	 */
	public StoreCheckExpandableListViewAdapter(Context context, HashMap<String, ArrayList<ProductDO>> hashProductWithBrand, StoreCheck storeCheck) 
	{
	...
	{
		int gridChildHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 68.805f, context.getResources().getDisplayMetrics());
