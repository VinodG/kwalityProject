...
public class CalendarUtils 
{
	...
	public static final String DATE_PATTERN1 = "yyyy-MM-dd'T'HH:mm";
...
//	public static final String DATE_PATTERN_FLIGHT_LIST = "EEE dd MMM yyyy";
	...
	public static final String EOT_PATTERN = "dd-MM-yyyy";
	
	public static final String DATE_PATTERN_PRINT = "dd/MM/yyyy'T'HH:mm:ss aa";
	...
	public static String getTimeToShow(String mDate)
	{
		String date = mDate;
		try {
			if(mDate.contains("T")){
	...
	/** this method returns Current dateofJorney in string form **/
	public static String getCurrentDateForEOT_PATTERN()
	{
		String date = null;
		
		SimpleDateFormat sdf = new SimpleDateFormat(EOT_PATTERN);
		date = sdf.format(new Date());
...
//				 diffrence = 2;
	...
	public static int getDiffBtwDatesInMinutes(String startDate,String endDate)
	{
		...
		calendar2.setTime(CalendarUtils.getDateFromString(endDate, CalendarUtils.DATE_PATTERN));
	...
	/** this method returns a Calendar object
	 * @param  Date And Time for Print Log
	 **/
...
//		int year = StringUtils.getInt(str[0]);
//		int month = StringUtils.getInt(str[1]);
...
//		strCurrentTime=hour+":"+minute + ":" + second + " " + am_pm;
	...
	public static String getFormatedDateForServiceCapture(String strDate)
	{
		String formatedDate  = null;
		try
		{
	...
	public static String getFormatedTimeForServiceCapture(String strDate)
	{
		String time = "";
		try
		{
...
//				strFormatedDate = " "+arrDate[2]+getDateNotation(StringUtils.getInt(arrDate[2]))+", "+getMonthAsString(StringUtils.getInt(arrDate[1])-1)+" "+arrDate[0];
	...
	public static String getOdometerDate(String strDate)
	{
		...
		try {
			if(strDate != null && !strDate.equals(""))
			{
				...
				String[] arrDate= strDate.split("T");
	...
	public static ArrayList<String> getMonthofYear()
	{
	    ...
	    for (int i = 0; i < 12; i++) 
	    {
	    	if((month + i ) > 11)
	    		j = 1;
			arrMonth.add(getMonthAndYearString(month+i,year+j));
		}
	    return arrMonth;
	}
}
