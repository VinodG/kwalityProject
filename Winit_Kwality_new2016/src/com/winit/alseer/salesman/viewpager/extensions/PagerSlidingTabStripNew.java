...
public class PagerSlidingTabStripNew extends HorizontalScrollView 
{
	...
	private int tabTextColor = Color.parseColor("#000000");//0xFF666666;
	private int tabTextColorUnselected = Color.parseColor("#8A8A8A");
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if(i== mPosition)
			{
				...
				if (v instanceof TextView) {
					...
					tab.setTextSize(getResources().getDimension(R.dimen.size4));
