...
package com.winit.alseer.salesman.viewpager.extensions;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = Color.parseColor("#B38C63");//0xFF666666;
	private int underlineColor = Color.parseColor("#B38C63");//0x1A000000;
	private int dividerColor = Color.parseColor("#C2C7CD");//0x1A000000;
	...
	private int tabTextColor = Color.parseColor("#B38C63");//0xFF666666;
	private int tabTextColorUnselected = Color.parseColor("#808080");
//	private Typeface tabTypeface = null;
	...
	private int devic_width;
	
	private int NO_OF_TABS = 4;

	public PagerSlidingTabStrip(Context context) {
		this(context, null);
		this.mContext = context;
		
//		if(BaseActivity.px >= 3)
//		else if(BaseActivity.px >= 2)
//			tabTextSize = (int)(9*BaseActivity.px);
//		else
//			tabTextSize = (int)(11.5*BaseActivity.px);
	}
...
//		defaultTabLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setText(title.toUpperCase());
		tab.setFocusable(true);
		tab.setGravity(Gravity.CENTER);
		tab.setTypeface(AppConstants.Roboto_Condensed_Bold);
		tab.setSingleLine();
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) 
		{
			if(i== mPosition)
			{
				...
				if(tabCount != 0 && tabCount <= NO_OF_TABS)
					defaultTabLayoutParams = new LinearLayout.LayoutParams(devic_width/tabCount, LayoutParams.MATCH_PARENT);
				else
					defaultTabLayoutParams = new LinearLayout.LayoutParams(devic_width/NO_OF_TABS, LayoutParams.MATCH_PARENT);
				...
				if (v instanceof TextView) 
				{
					...
					tab.setTypeface(AppConstants.Roboto_Condensed_Bold, tabTypefaceStyle);
					tab.setTextColor(tabTextColor);
					tab.setTextSize(getResources().getDimension(R.dimen.textsize_tabs));
...
//			((CaptureInventoryCategory) mContext).getSearchItems();
	...
	public void updateTextColor(int tabPosition,int colorId){
		int textColor = getResources().getColor(colorId);
		View v = tabsContainer.getChildAt(tabPosition);
		if (v instanceof TextView) {
			TextView tab = (TextView) v;
