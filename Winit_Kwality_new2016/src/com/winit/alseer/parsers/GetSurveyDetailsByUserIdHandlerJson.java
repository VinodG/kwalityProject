...
public class GetSurveyDetailsByUserIdHandlerJson extends BaseHandler
{
	...
	public GetSurveyDetailsByUserIdHandlerJson(InputStream is)
	{
		super(is);
		parse(is) ;
	}
	...
	public void parse(InputStream is) 
	{
		...
		try
		{
			...
			{
				JSONObject js = json.getJSONObject("Survey");
				JSONArray jsonArray = js.getJSONArray("SurveyQuestionList");
