...
public class InsertOrdersParser extends BaseHandler
{
	...
	public void endElement(String uri, String localName, String qName)throws SAXException 
	{
		...
		{
		case ENABLE:
			if(localName.equalsIgnoreCase("TrxCode"))
			{
				objOrders.strOldOrderNumber = currentValue.toString();
			}
			else if(localName.equalsIgnoreCase("AppTrxId"))
			{
			...
			else if(localName.equalsIgnoreCase("Status"))
			{
				...
				if(objOrders.pushStatus==2)
					objOrders.pushStatus=1;
			}
			else if(localName.equalsIgnoreCase("Division"))
			{
				objOrders.Division = StringUtils.getInt(currentValue.toString());
			}
