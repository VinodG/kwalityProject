...
public class LoadSummaryActivity extends BaseActivity
{
	//storecheck_screen_unilever.xml.xml
	...
	{
		llLoadRequestScreen = (LinearLayout) inflater.inflate(R.layout.summary_load_request_screen, null);
		...
		btnAdd.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				Intent intent = new Intent(LoadSummaryActivity.this, AddNewLoadRequest.class);
...
//Stock Verification
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			convertView.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View v)
				{
					Intent intent = new Intent(LoadSummaryActivity.this, MovementDetail.class);
					intent.putExtra("load_type", load_type);
	...
	private void loadRequestStatus(final boolean isFetchFromServer) {
		if (isNetworkConnectionAvailable(LoadSummaryActivity.this)) {
			...
			showCustomDialog(LoadSummaryActivity.this, "Warning !",
