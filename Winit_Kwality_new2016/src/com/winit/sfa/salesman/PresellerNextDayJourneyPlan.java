...
@SuppressLint("DefaultLocale") public class PresellerNextDayJourneyPlan extends BaseActivity implements  ConnectionExceptionListener
{
	//declaration of variables
	private LinearLayout llMain, llTimeTitle, llSearch, llMap,llgreenbar;
	...
	private HashMap<String, Integer> hmVisits1;
...
//		});
	...
	protected void onResume() 
	{
		...
		isOnResume = true;
//		LogUtils.errorLog("", "6 "+preference.getbooleanFromPreference(Preference.IS_EOT_DONE, false));
//		hideKeyBoard(llMain);
		...
		{
			showCustomDialog(PresellerNextDayJourneyPlan.this, getResources().getString(R.string.end_of_trip), getResources().getString(R.string.you_have_taken_five_minute_more) , getResources().getString(R.string.Yes), getResources().getString(R.string.No), "allPresellerCustomer");
		...
		{
			showCustomDialog(PresellerNextDayJourneyPlan.this, getResources().getString(R.string.end_of_trip), getResources().getString(R.string.you_successfully_served_all_customers), getResources().getString(R.string.Yes), getResources().getString(R.string.No), "allPresellerCustomer");
			preference.saveBooleanInPreference("isAllServed", true);
...
//		Log.e("", "7 "+preference.getbooleanFromPreference(Preference.IS_EOT_DONE, false));
	}
	...
	public void intialiseControls()
	{
		...
		tvTime.setTypeface(AppConstants.Roboto_Condensed);
		tvCustomers.setTypeface(AppConstants.Roboto_Condensed);
...
//			preference.commitPreference();
		...
		if(arrayListEvent.size() == 0)
		{
			...
			arrayListEvent = objCustomerDetailsBL.getNextDayJourneyPlan(timeStamp, currentDate, day, preference.getStringFromPreference(Preference.EMP_NO, "") );
...
//					ivCustCategory.setVisibility(View.VISIBLE);
					ivCustomerType.setImageResource(R.drawable.credit_tag);
...
//					}
				...
				else
				{
					...
					ivCustCategory.setVisibility(View.GONE);
					ivCustomerType.setImageResource(R.drawable.cash_tag);	
				}
...
//						if(preference.getbooleanFromPreference(Preference.IS_EOT_DONE, false))
//						{
//							showCustomDialog(PresellerNextDayJourneyPlan.this, getResources().getString(R.string.warning),"Trip has been already ended for the day ("+CalendarUtils.getCurrentDate()+")."  , getResources().getString(R.string.OK), null, "");
//						}
//						else 
//						{
////							if(isOrderGenerated(obj.site, CalendarUtils.getOrderPostDate()) && preference.getStringFromPreference(Preference.SALESMAN_TYPE, "").equalsIgnoreCase(AppConstants.SALESMAN_GT))
////							{
...
//									preference.commitPreference();
//									
//									Intent intent	=	new Intent(PresellerNextDayJourneyPlan.this,SalesmanCheckIn.class);
...
//										CheckIN  =	new Intent(PresellerNextDayJourneyPlan.this,SalesmanCheckIn.class);
...
//									preference.saveStringInPreference(Preference.CHANNEL_CODE, objMallsDetails.channelCode);
//									preference.commitPreference();
//									Intent intent =	new Intent(PresellerNextDayJourneyPlan.this,  SalesManTakeOrder.class);
...
//								else
//								{
//									Intent intent = new Intent(PresellerNextDayJourneyPlan.this, SalesmanOrderList.class);
//									intent.putExtra("object",obj);
//									startActivity(intent);
//								}
//							}
...
//				});
    ...
    public void onButtonYesClick(String from) 
    {
    		...
    		new Thread(new Runnable()
    		{
				...
				public void run()
				{
					...
					runOnUiThread(new Runnable()
					{
						...
						{
							hideLoader();
							Intent intent				 =	new Intent(PresellerNextDayJourneyPlan.this, SalesmanSummaryofDay.class);
    	...
    	else if(from.equalsIgnoreCase("reportsubmitted"))
    	{
			...
			new Handler().postDelayed(new Runnable() 
			{
				...
				{
					hideLoader();
					showCustomDialog(PresellerNextDayJourneyPlan.this, getResources().getString(R.string.successful), "E-mail sent successfully." , getResources().getString(R.string.OK), null, "finish");
				}
			},2000);
    	}
	...
	public void showSkipJourneyPlanPopup(String title, String strMessage)
	{
		...
		customDialog 				= 	new CustomDialog(PresellerNextDayJourneyPlan.this, view, preference.getIntFromPreference(AppConstants.Device_Display_Width, AppConstants.DEVICE_DISPLAY_WIDTH_DEFAULT) - 320, LayoutParams.WRAP_CONTENT, true);
...
//		btnNoPopup.setTypeface(AppConstants.Helvetica_LT_Condensed_Bold);
		...
		btnYesPopup.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
	    		...
	    		CustomBuilder builder = new CustomBuilder(PresellerNextDayJourneyPlan.this, "Select Reason", true);
